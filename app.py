...
UI_I18N = {
    'en': {
        'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7',
        ...
        'Co nowego w v8.6.7': 'What is new in v8.6.7',
    ...
    'es': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7', 'Nowa analiza':'Nuevo análisis','Feedback po zakupie':'Feedback tras la compra','Historia testów':'Historial de pruebas','1. Dane użytkownika':'1. Datos del usuario','2. Dane produktu':'2. Datos del producto','Płeć':'Sexo','kobieta':'mujer','mężczyzna':'hombre','System jednostek':'Sistema de unidades','metryczny':'métrico','imperialny':'imperial','Wiek':'Edad','Email':'Correo electrónico','Język':'Idioma'},
    'it': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nuova analisi','Feedback po zakupie':'Feedback post-acquisto','Historia testów':'Cronologia test','1. Dane użytkownika':'1. Dati utente','2. Dane produktu':'2. Dati prodotto','Płeć':'Genere','kobieta':'donna','mężczyzna':'uomo','System jednostek':'Sistema di unità','metryczny':'metrico','imperialny':'imperiale','Wiek':'Età','Email':'Email','Język':'Lingua'},
    'fr': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nouvelle analyse','Feedback po zakupie':'Retour après achat','Historia testów':'Historique des tests','1. Dane użytkownika':'1. Données utilisateur','2. Dane produktu':'2. Données produit','Płeć':'Sexe','kobieta':'femme','mężczyzna':'homme','System jednostek':'Système d’unités','metryczny':'métrique','imperialny':'impérial','Wiek':'Âge','Email':'E-mail','Język':'Langue'},
    'de': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Neue Analyse','Feedback po zakupie':'Feedback nach dem Kauf','Historia testów':'Testverlauf','1. Dane użytkownika':'1. Benutzerdaten','2. Dane produktu':'2. Produktdaten','Płeć':'Geschlecht','kobieta':'Frau','mężczyzna':'Mann','System jednostek':'Einheitensystem','metryczny':'metrisch','imperialny':'imperial','Wiek':'Alter','Email':'E-Mail','Język':'Sprache'},
    'ar': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'تحليل جديد','Feedback po zakupie':'ملاحظات بعد الشراء','Historia testów':'سجل الاختبارات','1. Dane użytkownika':'1. بيانات المستخدم','2. Dane produktu':'2. بيانات المنتج','Płeć':'الجنس','kobieta':'أنثى','mężczyzna':'ذكر','System jednostek':'نظام الوحدات','metryczny':'متري','imperialny':'إمبراطوري','Wiek':'العمر','Email':'البريد الإلكتروني','Język':'اللغة'},
    'ja': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'新規分析','Feedback po zakupie':'購入後フィードバック','Historia testów':'テスト履歴','1. Dane użytkownika':'1. ユーザーデータ','2. Dane produktu':'2. 商品データ','Płeć':'性別','kobieta':'女性','mężczyzna':'男性','System jednostek':'単位系','metryczny':'メートル法','imperialny':'ヤード・ポンド法','Wiek':'年齢','Email':'メール','Język':'言語'},
    'zh': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'新分析','Feedback po zakupie':'购买后反馈','Historia testów':'测试历史','1. Dane użytkownika':'1. 用户数据','2. Dane produktu':'2. 产品数据','Płeć':'性别','kobieta':'女性','mężczyzna':'男性','System jednostek':'单位制','metryczny':'公制','imperialny':'英制','Wiek':'年龄','Email':'电子邮件','Język':'语言'},
    'nl': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nieuwe analyse','Feedback po zakupie':'Feedback na aankoop','Historia testów':'Testgeschiedenis','1. Dane użytkownika':'1. Gebruikersgegevens','2. Dane produktu':'2. Productgegevens','Płeć':'Geslacht','kobieta':'vrouw','mężczyzna':'man','System jednostek':'Eenhedensysteem','metryczny':'metrisch','imperialny':'imperiaal','Wiek':'Leeftijd','Email':'E-mail','Język':'Taal'},
    'sv': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Ny analys','Feedback po zakupie':'Feedback efter köp','Historia testów':'Testhistorik','1. Dane użytkownika':'1. Användardata','2. Dane produktu':'2. Produktdata','Płeć':'Kön','kobieta':'kvinna','mężczyzna':'man','System jednostek':'Enhetssystem','metryczny':'metriskt','imperialny':'imperialt','Wiek':'Ålder','Email':'E-post','Język':'Språk'},
    'cs': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nová analýza','Feedback po zakupie':'Zpětná vazba po nákupu','Historia testów':'Historie testů','1. Dane użytkownika':'1. Údaje uživatele','2. Dane produktu':'2. Údaje o produktu','Płeć':'Pohlaví','kobieta':'žena','mężczyzna':'muž','System jednostek':'Systém jednotek','metryczny':'metrický','imperialny':'imperiální','Wiek':'Věk','Email':'E-mail','Język':'Jazyk'},
    'pt': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nova análise','Feedback po zakupie':'Feedback pós-compra','Historia testów':'Histórico de testes','1. Dane użytkownika':'1. Dados do usuário','2. Dane produktu':'2. Dados do produto','Płeć':'Género','kobieta':'mulher','mężczyzna':'homem','System jednostek':'Sistema de unidades','metryczny':'métrico','imperialny':'imperial','Wiek':'Idade','Email':'E-mail','Język':'Idioma'},
    'ru': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Новый анализ','Feedback po zakupie':'Отзыв после покупки','Historia testów':'История тестов','1. Dane użytkownika':'1. Данные пользователя','2. Dane produktu':'2. Данные товара','Płeć':'Пол','kobieta':'женщина','mężczyzna':'мужчина','System jednostek':'Система единиц','metryczny':'метрическая','imperialny':'имперская','Wiek':'Возраст','Email':'Email','Język':'Язык'},
    'el': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Νέα ανάλυση','Feedback po zakupie':'Ανατροφοδότηση μετά την αγορά','Historia testów':'Ιστορικό δοκιμών','1. Dane użytkownika':'1. Στοιχεία χρήστη','2. Dane produktu':'2. Στοιχεία προϊόντος','Płeć':'Φύλο','kobieta':'γυναίκα','mężczyzna':'άνδρας','System jednostek':'Σύστημα μονάδων','metryczny':'μετρικό','imperialny':'ιμπεριακό','Wiek':'Ηλικία','Email':'Email','Język':'Γλώσσα'},
    'hi': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'नया विश्लेषण','Feedback po zakupie':'खरीद के बाद प्रतिक्रिया','Historia testów':'टेस्ट इतिहास','1. Dane użytkownika':'1. उपयोगकर्ता डेटा','2. Dane produktu':'2. उत्पाद डेटा','Płeć':'लिंग','kobieta':'महिला','mężczyzna':'पुरुष','System jednostek':'मापन प्रणाली','metryczny':'मेट्रिक','imperialny':'इम्पीरियल','Wiek':'आयु','Email':'ईमेल','Język':'भाषा'},
    'bn': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'নতুন বিশ্লেষণ','Feedback po zakupie':'ক্রয়ের পর মতামত','Historia testów':'পরীক্ষার ইতিহাস','1. Dane użytkownika':'1. ব্যবহারকারীর তথ্য','2. Dane produktu':'2. পণ্যের তথ্য','Płeć':'লিঙ্গ','kobieta':'নারী','mężczyzna':'পুরুষ','System jednostek':'একক পদ্ধতি','metryczny':'মেট্রিক','imperialny':'ইম্পেরিয়াল','Wiek':'বয়স','Email':'ইমেল','Język':'ভাষা'},
    'ur': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'نیا تجزیہ','Feedback po zakupie':'خرید کے بعد فیڈبیک','Historia testów':'ٹیسٹ ہسٹری','1. Dane użytkownika':'1. صارف کا ڈیٹا','2. Dane produktu':'2. پروڈکٹ ڈیٹا','Płeć':'جنس','kobieta':'خاتون','mężczyzna':'مرد','System jednostek':'یونٹ سسٹم','metryczny':'میٹرک','imperialny':'امپیریل','Wiek':'عمر','Email':'ای میل','Język':'زبان'},
    'ko': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'새 분석','Feedback po zakupie':'구매 후 피드백','Historia testów':'테스트 기록','1. Dane użytkownika':'1. 사용자 데이터','2. Dane produktu':'2. 제품 데이터','Płeć':'성별','kobieta':'여성','mężczyzna':'남성','System jednostek':'단위 체계','metryczny':'미터법','imperialny':'야드파운드법','Wiek':'나이','Email':'이메일','Język':'언어'},
    'jv': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Analisis anyar','Feedback po zakupie':'Umpan balik sawise tuku','Historia testów':'Riwayat tes','1. Dane użytkownika':'1. Data pangguna','2. Dane produktu':'2. Data produk','Płeć':'Jinis kelamin','kobieta':'wadon','mężczyzna':'lanang','System jednostek':'Sistem ukuran','metryczny':'metrik','imperialny':'imperial','Wiek':'Umur','Email':'Email','Język':'Basa'},
    'tr': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Yeni analiz','Feedback po zakupie':'Satın alma sonrası geri bildirim','Historia testów':'Test geçmişi','1. Dane użytkownika':'1. Kullanıcı verileri','2. Dane produktu':'2. Ürün verileri','Płeć':'Cinsiyet','kobieta':'kadın','mężczyzna':'erkek','System jednostek':'Birim sistemi','metryczny':'metrik','imperialny':'emperyal','Wiek':'Yaş','Email':'E-posta','Język':'Dil'},
    'vi': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Phân tích mới','Feedback po zakupie':'Phản hồi sau mua','Historia testów':'Lịch sử kiểm tra','1. Dane użytkownika':'1. Dữ liệu người dùng','2. Dane produktu':'2. Dữ liệu sản phẩm','Płeć':'Giới tính','kobieta':'nữ','mężczyzna':'nam','System jednostek':'Hệ đơn vị','metryczny':'mét','imperialny':'anh mỹ','Wiek':'Tuổi','Email':'Email','Język':'Ngôn ngữ'},
    'ta': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'புதிய பகுப்பாய்வு','Feedback po zakupie':'வாங்கிய பிறகான கருத்து','Historia testów':'சோதனை வரலாறு','1. Dane użytkownika':'1. பயனர் தரவு','2. Dane produktu':'2. தயாரிப்பு தரவு','Płeć':'பாலினம்','kobieta':'பெண்','mężczyzna':'ஆண்','System jednostek':'அலகு அமைப்பு','metryczny':'மெட்ரிக்','imperialny':'இம்பீரியல்','Wiek':'வயது','Email':'மின்னஞ்சல்','Język':'மொழி'},
    'fa': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'تحلیل جدید','Feedback po zakupie':'بازخورد پس از خرید','Historia testów':'تاریخچه تست‌ها','1. Dane użytkownika':'1. داده‌های کاربر','2. Dane produktu':'2. داده‌های محصول','Płeć':'جنسیت','kobieta':'زن','mężczyzna':'مرد','System jednostek':'سیستم واحدها','metryczny':'متریک','imperialny':'امپریال','Wiek':'سن','Email':'ایمیل','Język':'زبان'},
    'ms': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Analisis baharu','Feedback po zakupie':'Maklum balas selepas pembelian','Historia testów':'Sejarah ujian','1. Dane użytkownika':'1. Data pengguna','2. Dane produktu':'2. Data produk','Płeć':'Jantina','kobieta':'wanita','mężczyzna':'lelaki','System jednostek':'Sistem unit','metryczny':'metrik','imperialny':'imperial','Wiek':'Umur','Email':'E-mel','Język':'Bahasa'},
    'uk': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Новий аналіз','Feedback po zakupie':'Відгук після покупки','Historia testów':'Історія тестів','1. Dane użytkownika':'1. Дані користувача','2. Dane produktu':'2. Дані продукту','Płeć':'Стать','kobieta':'жінка','mężczyzna':'чоловік','System jednostek':'Система одиниць','metryczny':'метрична','imperialny':'імперська','Wiek':'Вік','Email':'Email','Język':'Мова'},
    'da': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Ny analyse','Feedback po zakupie':'Feedback efter køb','Historia testów':'Testhistorik','1. Dane użytkownika':'1. Brugerdata','2. Dane produktu':'2. Produktdata','Płeć':'Køn','kobieta':'kvinde','mężczyzna':'mand','System jednostek':'Enhedssystem','metryczny':'metrisk','imperialny':'imperialt','Wiek':'Alder','Email':'E-mail','Język':'Sprog'},
    'no': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Ny analyse','Feedback po zakupie':'Tilbakemelding etter kjøp','Historia testów':'Testhistorikk','1. Dane użytkownika':'1. Brukerdata','2. Dane produktu':'2. Produktdata','Płeć':'Kjønn','kobieta':'kvinne','mężczyzna':'mann','System jednostek':'Enhetssystem','metryczny':'metrisk','imperialny':'imperial','Wiek':'Alder','Email':'E-post','Język':'Språk'},
    'ro': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Analiză nouă','Feedback po zakupie':'Feedback după cumpărare','Historia testów':'Istoric teste','1. Dane użytkownika':'1. Date utilizator','2. Dane produktu':'2. Date produs','Płeć':'Gen','kobieta':'femeie','mężczyzna':'bărbat','System jednostek':'Sistem de unități','metryczny':'metric','imperialny':'imperial','Wiek':'Vârstă','Email':'Email','Język':'Limbă'},
    'bg': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Нов анализ','Feedback po zakupie':'Обратна връзка след покупка','Historia testów':'История на тестовете','1. Dane użytkownika':'1. Данни за потребителя','2. Dane produktu':'2. Данни за продукта','Płeć':'Пол','kobieta':'жена','mężczyzna':'мъж','System jednostek':'Система единици','metryczny':'метрична','imperialny':'имперска','Wiek':'Възраст','Email':'Имейл','Język':'Език'},
    'sr': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Нова анализа','Feedback po zakupie':'Повратна информација након куповине','Historia testów':'Историја тестова','1. Dane użytkownika':'1. Подаци о кориснику','2. Dane produktu':'2. Подаци о производу','Płeć':'Пол','kobieta':'жена','mężczyzna':'мушкарац','System jednostek':'Систем јединица','metryczny':'метрички','imperialny':'империјални','Wiek':'Узраст','Email':'Имејл','Język':'Језик'},
    'hr': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nova analiza','Feedback po zakupie':'Povratne informacije nakon kupnje','Historia testów':'Povijest testova','1. Dane użytkownika':'1. Podaci korisnika','2. Dane produktu':'2. Podaci o proizvodu','Płeć':'Spol','kobieta':'žena','mężczyzna':'muškarac','System jednostek':'Sustav jedinica','metryczny':'metrički','imperialny':'imperijalni','Wiek':'Dob','Email':'E-pošta','Język':'Jezik'},
    'sk': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nová analýza','Feedback po zakupie':'Spätná väzba po nákupe','Historia testów':'História testov','1. Dane użytkownika':'1. Údaje používateľa','2. Dane produktu':'2. Údaje o produkte','Płeć':'Pohlavie','kobieta':'žena','mężczyzna':'muž','System jednostek':'Systém jednotiek','metryczny':'metrický','imperialny':'imperiálny','Wiek':'Vek','Email':'E-mail','Język':'Jazyk'},
    'sl': {'ATEENA-ST MVP — Apparel v8.6.7': 'ATEENA-ST MVP — Apparel v8.6.7','Nowa analiza':'Nova analiza','Feedback po zakupie':'Povratne informacije po nakupu','Historia testów':'Zgodovina testov','1. Dane użytkownika':'1. Podatki uporabnika','2. Dane produktu':'2. Podatki o izdelku','Płeć':'Spol','kobieta':'ženska','mężczyzna':'moški','System jednostek':'Sistem enot','metryczny':'metrični','imperialny':'imperialni','Wiek':'Starost','Email':'E-pošta','Język':'Jezik'},
...
st.set_page_config(page_title='ATEENA-ST MVP — Apparel v8.6.7', page_icon='👗', layout='wide')
init_db()
...
st.title(tr('ATEENA-ST MVP — Apparel v8.6.7'))
st.caption(tr_text('V8.6.7 adds to V7.4: integrated Capture Pro session save into main analysis, optional BACK capture in Capture Pro, stronger hand-off from mobile capture to product analysis, and stricter photo reuse flow.'))
...
with st.expander(tr('Co nowego w v8.6.7'), expanded=False):
    st.markdown(
        """
                    ...
                    with st.spinner('Uruchamiam OCR fallback dla produktu, tabeli i opinii...'):
                        try:
                            ...
                            if review_lines:
                                ...
                                product_result.parsing_notes = list(getattr(product_result, 'parsing_notes', []) or []) + ['Review screenshot / OCR applied in V8.6.7.']
                            st.session_state['product_result'] = product_result
            ...
            with st.expander('OCR fallback 4.0 — popraw dane produktu ręcznie', expanded=False):
                ...
                if st.button('Zastosuj korekty OCR / screenshot', key='apply_ocr_corrections_btn', use_container_width=True):
                    try:
                        ...
                        product_result.parsing_notes = list(getattr(product_result, 'parsing_notes', []) or []) + ['Manual OCR correction applied in V8.6.7.']
                        st.session_state['product_result'] = product_result
...
with capture_tab:
    ...
    st.caption('V8.6.7 łączy Capture Pro z główną analizą. Możesz zrobić FRONT / PROFIL / TYŁ, przejść quality gate i jednym kliknięciem zapisać zdjęcia do „Nowa analiza”.')
    ...
    with c_a:
        ...
        st.caption('W V8.6.7 możesz zapisać sesję Capture Pro i wykorzystać ją bezpośrednio w głównej analizie.')
